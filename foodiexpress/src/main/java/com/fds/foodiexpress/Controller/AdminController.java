...
public class AdminController {
	...
	public String adminDashboard(Model model) {
        ...
        if (authentication != null) {
            email= authentication.getName(); // Returns the username
        }
    ...
    public String toggleFlag(@RequestParam String email,@RequestParam String tab, RedirectAttributes redirectAttributes) {
